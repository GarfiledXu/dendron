...
3. 问题描述:
   ...
   2. ![alt text](assets/image-20250527_092230-ce7b5bbd.png)
...
3. 问题描述:
   ...
   2. ![alt text](assets/image-20250527_155830-9b416519.jpg)
   3. SaaS特权用印照片一直显示同步中
...
3. 问题描述:
   1. ![alt text](assets/image-20250527_164809-17375245.jpg)
   2. ![alt text](assets/image-20250527_164825-372701b5.jpg)
...
3. 问题描述:
   ...
   2. ![alt text](assets/image-20250528_150459-2bc1f09f.png)
...
3. 问题描述:
   ...
   2. ![alt text](assets/image-20250529_094616-f9849333.png)
   3. 有视频
...
3. 问题描述:
   ...
   2. 操作完以后客户测试还是没有影像
   3. ![alt text](assets/image-20250529_160330-b119c348.png)
...
6. 过程记录:
   ...
   4. ![alt text](assets/image-20250530_102250-f436946a.png)
   5. 寄回维修吧，拍摄进程视频通道一直初始化失败，没法拍照，可能摄像头或硬件有问题
   6. 售后详情: 发现镜像版本较老，从2.4升级到2.7以后，拍照正常，有可能是固件功能和镜像版本不匹配
   7. ![alt text](assets/image-20250606_153148-d160431e.png)
...
3. 问题描述:
   ...
   2. ![alt text](assets/image-20250530_161333-f669958f.png)
   3. ![alt text](assets/image-20250530_161347-ec0eaae0.png)
   4. ![alt text](assets/image-20250530_161403-d28f20b9.png)
...
6. 过程记录:
   ...
   6. TODO: 为什么用印结束后一直没有触发登出
      1. 登出条件  isNeedLogout isLoging
         ...
         7. 在用印时，收到加锁指令，需要登出
         8. 接收到logout的消息
   7. ![alt text](assets/image-20250530_174015-5a175752.png)
   8. 休眠和挂机的区别？
