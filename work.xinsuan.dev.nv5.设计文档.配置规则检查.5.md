---
id: gyruczo70z6qrgxrtdhvxbq
title: '5'
desc: ''
updated: 1778061333227
created: 1778061304851
---
...
本模块定位于上下位机交互中的“实体状态独立预检服务”。它提供一个无副作用的查询接口，允许上位机在执行设定修改（SetParam）或控制触发（Trigger/Learn）之前，同步获取下位机系统、程序或工具节点的规则合法性与状态就绪度。
